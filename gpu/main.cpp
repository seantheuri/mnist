...
int main(int argc, char **argv)
{
    ...
    model->add("residual", { 64, 3, 1 });
    model->add("residual", { 64, 3, 1 });
    model->add("residual", { 128, 3, 2 });
    model->add("residual", { 128, 3, 1 });
    model->add("residual", { 256, 3, 2 });
    model->add("residual", { 256, 3, 1 });
    model->add("residual", { 512, 3, 2 });
    model->add("residual", { 512, 3, 1 });
    model->add("avg pool", { 4 });
